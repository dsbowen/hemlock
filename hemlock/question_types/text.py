...
@Question.register(type='text', registration='html_compiler')
...
@Question.register(type='text', registration='response_recorder')
def text_response(question, response):
    return

@Question.register(type='text', registration='data_recorder')
