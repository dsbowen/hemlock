...
def Tools(origin=None):
    ...
    p = Page(b)
    Label(p, label='<p>This page contains custom javascript.</p>')
    p.add_external_js(src=url_for('static', filename='external_js.js'))
    p.add_internal_js('''
    $(document).ready(function(){ 
        alert("This alert was generated by internal javascript"); 
    }) 
    ''')

    p = Page(b)
    Label(p, label='<p>This page contains custom css.</p>')
    p.add_external_css(href=url_for('static', filename='external_css.css'))
    p.add_internal_css({'form': {'background-color': 'lightgreen'}})
